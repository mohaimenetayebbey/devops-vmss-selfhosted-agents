param(
    ...
    [String] [Parameter (Mandatory=$false)] $GalleryName,
    [String] [Parameter (Mandatory=$false)] $GalleryResourceGroupName,
    [String] [Parameter (Mandatory=$false)] $GalleryImageName,
    [String] [Parameter (Mandatory=$false)] $GalleryImageVersion,
    [String] [Parameter (Mandatory=$false)] $GalleryReplicationRegions = "[]",
...
packer build    -only "$buildName*" `
                ...
                -var "gallery_resource_group_name=$GalleryResourceGroupName" `
                -var "gallery_image_name=$GalleryImageName" `
                -var "gallery_image_version=$GalleryImageVersion" `
                -var "gallery_replication_regions=$GalleryReplicationRegions" `
                -color=false `
                $TemplatePath `
        | Where-Object {
